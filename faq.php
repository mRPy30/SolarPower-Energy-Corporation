...
<body> 
    ...
    <style>
        ...
        /* Hero Section */
        .faq-hero {
            background: linear-gradient(135deg, rgba(45, 80, 22, 0.9), rgba(45, 80, 22, 0.7)), 
                        url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 400"><rect fill="%232d5016" width="1200" height="400"/></svg>');
