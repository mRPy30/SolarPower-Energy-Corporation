...
$_promoJsonFile = __DIR__ . '/promo-images.json';
...
// Cache-bust so browsers always show the latest upload
$_cb = filemtime($_promoJsonFile ?: $_promoJsonFile) ?: time();
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container">
            <div class="row g-4 promo-row">
                ...
                <div class="col-md-6 d-flex">
                    <a href="https://www.facebook.com/share/p/1Lo6QbRZm6/" target="_blank" rel="noopener noreferrer"
                       class="promo-card promo-card-main promo-link-wrap">
                        <img src="<?= htmlspecialchars($_promoConfig['main']) ?>?v=<?= $_cb ?>"
                             alt="Solar Power Solutions" class="promo-video-bg">
                ...
                <div class="col-md-6 promo-right-col">
                    ...
                    <a href="https://www.facebook.com/permalink.php?story_fbid=pfbid02XrvG3bZ8mQH6f6kPHqPmrmSWxeTDcR6kWmgVgo8NUWkaZ77srag41zQjFqStU4rMl&id=61578373983187"
                       ...
                       class="promo-card promo-card-sm promo-link-wrap">
                        <img src="<?= htmlspecialchars($_promoConfig['top']) ?>?v=<?= $_cb ?>"
                             alt="Grid-Tie Packages">
                        <div class="fb-hover-badge"><i class="fab fa-facebook"></i> View Post</div>
                    </a>
                    ...
                    <a href="https://www.facebook.com/photo/?fbid=122169296384945799"
                       target="_blank" rel="noopener noreferrer"
                       class="promo-card promo-card-sm promo-link-wrap">
                        <img src="<?= htmlspecialchars($_promoConfig['bottom']) ?>?v=<?= $_cb ?>"
                             alt="Hybrid Packages">
                        <div class="fb-hover-badge"><i class="fab fa-facebook"></i> View Post</div>
                    </a>
