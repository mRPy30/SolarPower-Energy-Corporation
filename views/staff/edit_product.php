...
$moq = isset($_POST['moq']) ? max(1, intval($_POST['moq'])) : 1;
...
try {
    ...
    $stmt->bind_param("ssdsissii", $displayName, $brandName, $price, $category, $stockQuantity, $warranty, $description, $moq, $product_id);
