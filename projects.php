    ...
    <section class="py-5">
        <div class="container">
                ...
                <div class="col-lg-6" data-aos="fade-up">
                    <div class="project-card">
                        <div class="project-img-box">
                            <img src="assets/img/BF-Homes.webp" class="w-100 h-100 object-fit-cover" alt="Residential Project">
            ...
            <!--<div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="project-card">
                        <div class="project-img-box">
                            <img src="assets/img/Lucero-Pangasinan.webp" class="w-100 h-100 object-fit-cover" alt="Commercial Project">
                            <span class="location-tag"><i class="fas fa-map-marker-alt me-2"></i>Lucero, Pangasinan</span>
                        </div>
                        <div class="p-4">
                             <h4 class="fw-bold">Lucero, Pangasinan</h4>
                            <ul>
                ...
                <div class="col-lg-6 more-projects" style="display: none;" data-aos="fade-up">
                    <div class="project-card">
                        <div class="project-img-box">
                            <img src="assets/img/Mabini-Batangas.webp" class="w-100 h-100 object-fit-cover" alt="Residential Project">
                            <span class="location-tag"><i class="fas fa-map-marker-alt me-2"></i>Makati City</span>
                        </div>
                        <div class="p-4">
                            <h4 class="fw-bold">Mabini,Batangas</h4>
                            <ul>
                ...
                <div class="col-lg-6 more-projects" style="display: none;" data-aos="fade-up" data-aos-delay="200">
                    <div class="project-card">
                        <div class="project-img-box">
                            <img src="assets/img/San-Pablo.webp" class="w-100 h-100 object-fit-cover" alt="Commercial Project">
                            <span class="location-tag"><i class="fas fa-map-marker-alt me-2"></i>Quezon City</span>
                        </div>
                        <div class="p-4">
                             <h4 class="fw-bold">San Pablo, Laguna</h4>
                            <ul>
                ...
                <div class="col-lg-6 more-projects" style="display: none;" data-aos="fade-up">
                    <div class="project-card">
                        <div class="project-img-box">
                            <img src="assets/img/Nueva-Viscaya.webp" class="w-100 h-100 object-fit-cover" alt="Residential Project">
                            <span class="location-tag"><i class="fas fa-map-marker-alt me-2"></i>Cavite</span>
                        </div>
                        <div class="p-4">
                            <h4 class="fw-bold">Bayombong, Nueva Viscaya</h4>
                            <ul>
                ...
                <div class="col-lg-6 more-projects" style="display: none;" data-aos="fade-up" data-aos-delay="200">
                    <div class="project-card">
                        <div class="project-img-box">
                            <img src="assets/img/Famy-Laguna.webp" class="w-100 h-100 object-fit-cover" alt="Commercial Project">
                            <span class="location-tag"><i class="fas fa-map-marker-alt me-2"></i>Bulacan</span>
                        </div>
                        <div class="p-4">
                             <h4 class="fw-bold">Famy, Laguna</h4>
                            <ul>
        ...
        <div class="container py-5">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
                    <div class="feature-box">
                        <div class="d-flex align-items-center mb-3">
                            <img src="assets/img/user1.jpg" alt="Patrick Burgos" class="rounded-circle me-3" style="width: 60px; height: 60px; object-fit: cover;">
                            <div>
                                <strong>Patrick Burgos</strong>
                                <p class="text-muted small mb-0">Pangasinan</p>
                            </div>
                        </div>
                        <div class="mb-3">
                            <i class="fas fa-star text-warning"></i>
                        ...
                        <p class="text-muted fst-italic">"I highly recommend them for their excellent service and reliable solutions. From consultation to installation, their team was professional, knowledgeable, and efficient. Well Done !"</p>
                    </div>
                </div>
                <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="feature-box">
                        <div class="d-flex align-items-center mb-3">
                            <img src="assets/img/user2.jpg" alt="Rayne Home" class="rounded-circle me-3" style="width: 60px; height: 60px; object-fit: cover;">
                            <div>
                                <strong>Rayne Home</strong>
