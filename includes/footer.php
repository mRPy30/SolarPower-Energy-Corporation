...
<<<<<<< HEAD
    ...
    .footer {
        ...
        color: #1E4940;
        /* Darker tone, keeping original for contrast */
    ...
    .social-links a {
        ...
        height: 40px;
        background: #2c2c2c;
        /* Keeping original dark background */
        border-radius: 50%;
        display: flex;
        align-items: center;
    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="footer-logo-social">
          ...
          <div class="social-links">
            <a href="https://www.facebook.com/p/SolarPower-Energy-Corporation-61578373983187/" target="_blank"
              rel="noopener noreferrer">
              <i class="fab fa-facebook-f"></i>
            </a>
            <a href="https://www.instagram.com/solarpowerenergycorporation?igsh=MWh4YTEyYWpzbDNlNQ%3D%3D"
              target="_blank"><i class="fab fa-instagram"></i></a>
            <a href="https://www.tiktok.com/@solarpower.energy?_r=1&_t=ZS-92HlpTBUuzF" target="_blank"><i
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="footer-contact">
          ...
          <div class="contact-detail">
            <i class="fas fa-phone"></i>
            <span class="contact-link" id="phone-copy" onclick="copyToClipboard('0995-394-7379', this)">+63 995 394
              7379</span>
          </div>
          <div class="contact-detail">
            <i class="fas fa-map-marker-alt"></i>
            <span>4/F PBB Corporate Center, 1906 Finance Drive, Madrigal Business Park 1, Ayala Alabang, Muntinlupa
              City, 1780, Philippines</span>
          </div>
        </div>
      </div>
