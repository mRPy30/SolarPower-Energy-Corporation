    ...
    <section class="hero-about">
        <div class="container" data-aos="fade-up">
            <div class="text-center">
                <span
                    style="color: var(--clr-primary); font-weight: 700; text-transform: uppercase; letter-spacing: 2px;">WHO
                    WE ARE</span>
        ...
        <div class="container py-lg-5">
            <div class="row align-items-center">
                <div class="col-lg-5 text-center mb-5 mb-lg-0" data-aos="fade-right">
                    <img src="assets/img/new_logo.png" alt="Logo" class="img-fluid" style="max-width: 280px;">
                </div>
                <div class="col-lg-7" data-aos="fade-left">
                    <h2>SolarPower Energy Corporation</h2>
                    <p>The company is a renewable energy solutions provide committed to making clean, affordable, and
                        sustainable solar power accessible to homes, businesses, and communities across Philippines.
                        Established in 2025, our company specializes in the design, installation, and maintenance of
                        solar photovoltaic (PV) systems tailored to meet diverse energy needs.</p>
                    <p>As a new and dynamic player in the solar industry, we bring fresh ideas, cutting-edge technology,
                        and a deep commitment to environmental sustainability. Our mission is to accelerate the
                        transition to renewable energy by offering efficient, cost-effective solar solutions that reduce
                        electricity costs and carbon footprints.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0" data-aos="fade-right">
                    ...
                    <p class="lead mb-4">We are proud to be a Department of Energy (DOE) recognized solar service
                        provider.</p>
        ...
        <div class="row g-0">
            <div class="col-md-6" data-aos="fade-up">
                <div class="mission-box text-center">
                    ...
                    <p class="fs-5">To promote sustainable living by providing reliable and cost-efficient solar energy
                        solutions.</p>
                </div>
            </div>
            <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
                <div class="vision-box text-center">
                    ...
                    <p class="fs-5">To become a leading solar energy provider nationwide, empowering every Filipino to
                        save energy.</p>
                </div>
            </div>
        </div>
