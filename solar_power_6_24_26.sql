...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 24, 2026 at 10:54 AM
...
INSERT INTO `orders` (`id`, `order_reference`, `customer_name`, `customer_email`, `customer_phone`, `customer_address`, `customer_city`, `total_amount`, `payment_method`, `payment_status`, `order_status`, `receipt_path`, `tracking_number`, `staff_notes`, `current_location`, `estimated_delivery`, `delivered_at`, `created_at`, `sales_channel`, `service_type`, `remarks`) VALUES
(48, 'ORD-20260606-7936C7', 'Janvier Erickson', 'janvieraraque@gmail.com', '+639706911766', 'Blk 11 lot 38, Poblacion I, Mendez, Cavite', NULL, 331200.00, 'instapay', 'pending', 'pending', 'uploads/receipts/RCP-1780725036-6a23b52cbf4fc.png', NULL, NULL, NULL, NULL, NULL, '2026-06-06 05:50:36', 'Website', 'Site Assessment', NULL);
...
(241, '750kw', 'JA Solar', 5000.00, 'Panel', NULL, 9999, '5 years', '<p><strong style=\"color: rgb(51, 51, 51);\">750kw bifacial</strong></p><p>VAT Included</p><p><br></p>', 'uploads/products/241/variant_2_6a3b948628568.png', 10, 1, 'Active'),
